...
namespace CareerCloud.BusinessLogicLayer
{
        ...
        public override void Add(CompanyJobSkillPoco[] pocos)
        {
            ...
            {
                poco.Importance = poco.Importance;
        ...
        protected void Verify(CompanyJobSkillPoco[] pocos)
        {
            ...
            foreach (var poco in pocos)
            {
                ...
                {
                    exceptions.Add(new ValidationException(400, $"Importance for CompanyJobSkill {poco.Importance} cannot be less than 0"));
                }
            }
